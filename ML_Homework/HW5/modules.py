...
Original file is located at
    https://colab.research.google.com/drive/1yM_rHtRE5t5bQJPZTrzo8B_kwiYpe7bw
...
class Sequential(Module):
    ...
    def updateOutput(self, input):
        ...
        for i in range(len(self.modules)):
            self.outputs.append(self.modules[i].forward(self.outputs[i]))
    ...
    def backward(self, input, gradOutput):
        ...
        for i in range(len(self.modules) - 1, -1, -1):
            self.gradInput = self.modules[i].backward(outputs[i], self.gradInput)
...
class SoftMax(Module):
    ...
    def updateGradInput(self, input, gradOutput):
        ...
        self.gradInput -= self.output * np.sum(gradOutput * self.output, axis=1).reshape(-1, 1)
        return self.gradInput
